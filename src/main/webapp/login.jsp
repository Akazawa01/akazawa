...
<body>
<div class="container"> <h1>勤怠管理システム</h1>
...
<p class="error-message"><c:out value="${errorMessage}"/></p> <c:if test="${not empty sessionScope.successMessage}">
<p class="success-message"><c:out value="${sessionScope.successMessage}"/></p>
<c:remove var="successMessage" scope="session"/> </c:if>
    </div>
</body>
</html>